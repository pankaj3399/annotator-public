      ...
      <div className='min-h-screen '>
        ...
        <main className='w-full mx-auto space-y-5  sm:px-6 lg:px-8'>
          <div className='flex gap-5'>
            <ChartComponent
              statuses={data.tasksData.statuses ? data.tasksData.statuses : []}
              totalTasks={
                data.tasksData.totalTasks ? data.tasksData.totalTasks : 0
              }
            />
            <AverageTaskTimeCardComponent
              time={data.tasksData.averageTime ? data.tasksData.averageTime : 0}
              totalTasks={
                data.tasksData.totalTasks ? data.tasksData.totalTasks : 0
              }
            />
          ...
          <DashboardOverviewCardComponent
            ...
            annotator={data.annotators ? data.annotators : 0}
            totalTasks={
              data.tasksData.totalTasks ? data.tasksData.totalTasks : 0
            }
          />
