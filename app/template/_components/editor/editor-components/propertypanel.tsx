      ...
      case 'videoAnnotation': {
        ...
        return (
          <div className='space-y-4'>
            ...
            {/* Video URL (Optional - for preview during template design) */}
            <div className='space-y-2'>
              ...
              <Input
                ...
                placeholder='https://example.com/video.mp4 (or upload via interface)'
              />
              <div className='text-xs text-gray-500'>
                💡 You can also upload a video file using the upload interface
                above.
              </div>
            </div>
            ...
            <div className='space-y-2'>
              ...
              <Textarea
                ...
                placeholder='Watch the video and annotate objects at specific timestamps.'
                rows={3}
              />
              <div className='text-xs text-gray-500'>
                These instructions will be shown to annotators during the
            ...
            <div className='space-y-2'>
              ...
              <div className='text-xs text-gray-500 mb-2'>
                ⚠️ These labels will be used for all annotation tasks created
                from this template.
              </div>
